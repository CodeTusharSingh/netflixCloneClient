...
function Step2of1() {
  ...
  const check = async () => {
    try {
      ...
      const tokenResponse = await fetch('https://netflixcloneserver-production.up.railway.app/main', {
        method: 'GET',
        headers: {
      ...
      if (tokenResponse.status === 201) {
        ...
        const response = await fetch('https://netflixcloneserver-production.up.railway.app/step2of1', {
          method: 'GET',
          headers: {
            Accept: 'application/json',
            'Content-Type': 'application/json',
