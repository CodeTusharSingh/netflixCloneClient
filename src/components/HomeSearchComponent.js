...
function HomeSearchComponent({ contents }) {
    ...
    const check = async () => {
        try {
            const response = await fetch('https://netflixcloneserver-production.up.railway.app/home', {
                method: 'GET',
                headers: {
    ...
    const checkContent = async (index) => {
        try {
            const response = await fetch('https://netflixcloneserver-production.up.railway.app/userList/check', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    const handleListClick = async (index) => {
        if (removeRef.current[index].style.display === 'none') {
            ...
            addRef.current[index].style.display = 'none';
            try {
                const response = await fetch('https://netflixcloneserver-production.up.railway.app/userList/add', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                    },
            ...
            try {
                const response = await fetch('https://netflixcloneserver-production.up.railway.app/userList/remove', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                    },
    ...
    const playContent = async (index) => {
        ...
        try {
            const response = await fetch('https://netflixcloneserver-production.up.railway.app/userHistory/add', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    return (
        <>
            <div ref={homeContainerRef} style={{ marginLeft: '50px' }}>
                <h1 style={{ color: 'white', fontFamily: 'NetflixSansLite', position: 'sticky', top: '90px', zIndex: '100', paddingTop: '10px' }}>Search Result</h1>
                <br></br>
