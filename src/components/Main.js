...
function Main() {
    ...
    const check = async () => {
        try {
            const response = await fetch('https://netflixcloneserver-production.up.railway.app/main', {
                method: 'GET',
                headers: {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch('https://netflixcloneserver-production.up.railway.app/generateToken', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
            ...
            if (response.status === 201) {
                const res = await fetch('https://netflixcloneserver-production.up.railway.app/reg', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                    },
