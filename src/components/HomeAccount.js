...
function HomeAccount() {
    ...
    const userInformation = async () => {
        try {
            const response = await fetch(`https://netflixcloneserver-production.up.railway.app/homeaccount/${email}`, {
                method: 'GET',
                headers: {
                    Accept: 'application/json',
                    'Content-Type': 'application/json',
    ...
    const fetchFeedback = async () => {
        try {
            const response = await fetch(`https://netflixcloneserver-production.up.railway.app/user/feedback/check/${email}`, {
                method: 'GET',
                headers: {
                    Accept: 'application/json',
                    'Content-Type': 'application/json',
    ...
    const handleSubmit = async () => {
        try {
            const response = await fetch(`https://netflixcloneserver-production.up.railway.app/user/feedback`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    const handleDelete = async () => {
        try {
            const response = await fetch(`https://netflixcloneserver-production.up.railway.app/user/feedback/delete`, {
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json',
                },
