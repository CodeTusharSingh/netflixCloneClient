...
function Step1of3() {
    ...
    const check = async () => {
        try {
            const response = await fetch('https://netflixcloneserver-production.up.railway.app/verifyAllToken', {
                method: 'GET',
                headers: {
    ...
    const handleClick = async (e) => {
        ...
        e.preventDefault();
        try {
            const response = await fetch('https://netflixcloneserver-production.up.railway.app/api/getkey', {
                method: 'GET',
                headers: {
                    Accept: 'application/json',
                    'Content-Type': 'application/json',
            ...
            const planResponse = await fetch('https://netflixcloneserver-production.up.railway.app/getPlan', {
                method: 'GET',
                headers: {
                    Accept: 'application/json',
                    'Content-Type': 'application/json',
            ...
            const res = await fetch('https://netflixcloneserver-production.up.railway.app/checkout', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
            ...
            const options = {
                ...
                order_id: id,
                callback_url: `https://netflixcloneserver-production.up.railway.app/paymentverification`,
